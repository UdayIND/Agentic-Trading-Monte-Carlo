...
| IB-12 | 2026-07-03 | NVDA order session | python missing on this machine — tools/guard.py + regime.py + scheduled runs cannot execute | deterministic gates actually runnable | **DONE** (2026-07-03: Python 3.12.10 was installed all along — PATH issue; invoke via `py -3.12`; 25/25 tests green; cron scripts should use the `py` launcher) |
